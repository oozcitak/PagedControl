...
$ProjDir  = Join-Path -Path $ScriptDir -ChildPath "PagedControl\"
$ProjFile  = Join-Path -Path $ScriptDir -ChildPath "PagedControl\PagedControl.csproj"
$PackFile = Join-Path -Path $ScriptDir -ChildPath "PagedControl\*.nupkg"
